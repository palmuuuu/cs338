...
Does e\*d mod lambda(n) = 1? There are various relationships that you would expect these numbers to have, so show me that they do in fact have those relationships.

For e\*d mod lambda(n) = 1 or not, first we know that e or public exponent is 65537.
d or private exponent can be calculated from this:
![Alt text](img/d.png)
